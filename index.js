...
var lr_start = 1; //1st Living Room Light
var br_start = 4; //1st Bedroom Light

//create empty light array
var light = [];
...
app.get('/SkyScene', function (req, res) {
	f_light = lr_start;
	light[f_light] 		= {"on":true, "bri":254, "hue":34258, "sat":176, "effect":"none", "xy":[0.3327,0.3413], "ct":181};
	light[f_light + 1] 	= {"on":true, "bri":247, "hue":40891, "sat":252, "effect":"none", "xy":[0.2380,0.1797], "ct":500};
	light[f_light + 2] 	= {"on":true, "bri":254, "hue":34258, "sat":176, "effect":"none", "xy":[0.3327,0.3413], "ct":181};
	colorchange('Sky');
	res.sendStatus(200);
});
...
app.get('/NightlifeScene', function (req, res) {
	f_light = lr_start;
	light[f_light] 		= {"on":true, "bri":254, "hue":47125, "sat":253, "effect":"none", "xy":[0.1684,0.0416], "ct":500};
	light[f_light + 1] 	= {"on":true, "bri":254, "hue":63494, "sat":253, "effect":"none", "xy":[0.6178,0.2911], "ct":500};
	light[f_light + 2] 	= {"on":true, "bri":254, "hue":48695, "sat":253, "effect":"none", "xy":[0.2115,0.0656], "ct":500};
...
app.get('/AuroraScene', function (req, res) {
	f_light = lr_start;
	light[f_light] 		= {"on":true, "bri":85, "hue":15955, "sat":  79, "effect":"none", "xy":[0.4080,0.5170], "ct":307};
	light[f_light + 1] 	= {"on":true, "bri":85, "hue":15187, "sat": 129, "effect":"none", "xy":[0.3847,0.4707], "ct":353};
	light[f_light + 2] 	= {"on":true, "bri":51, "hue":15629, "sat": 102, "effect":"none", "xy":[0.4080,0.5170], "ct":325};
	colorchange('Aurora');
	res.sendStatus(200);
});
...
app.get('/CinemaScene', function (req, res) {
	f_light = lr_start;
	light[f_light] 		= {"on":true, "bri":254, "hue":65527, "sat":253, "effect":"none", "xy":[0.6736,0.3221], "ct":500};
	light[f_light + 1] 	= {"on":true, "bri":254, "hue":10660, "sat":252, "effect":"none", "xy":[0.5628,0.4034], "ct":500};
	light[f_light + 2] 	= {"on":true, "bri":254, "hue":6396 , "sat":253, "effect":"none", "xy":[0.6077,0.3710], "ct":500};
	colorchange('Cinema');
	res.sendStatus(200);
});
...
app.get('/WaveScene', function (req, res) {
	f_light = lr_start;
	light[f_light] 		= {"on":true, "bri": 76, "hue":41977, "sat":252, "effect":"none", "xy":[0.2259,0.1557], "ct": 500};
	light[f_light + 1] 	= {"on":true, "bri": 72, "hue":41630, "sat":252, "effect":"none", "xy":[0.2298,0.1634], "ct": 500};
	light[f_light + 2] 	= {"on":true, "bri": 54, "hue":40760, "sat":253, "effect":"none", "xy":[0.2389,0.1818], "ct": 500};
	colorchange('Wave');
	res.sendStatus(200);
});
...
//Start Normal Scene
app.get('/NormalScene', function (req, res) {
	f_light = br_start;
	var lightcolor = {"on":true, "bri":254, "hue":14213, "sat":130, "effect":"none", "xy":[0.4556,0.4045], "ct":362};
	samecolor('Bed', lightcolor);
	res.sendStatus(200);
});
...
//Start Midnight Scene
app.get('/MidnightScene', function (req, res) {
	f_light = br_start;
	light[f_light] 		= {"on":true, "bri":120, "hue":47125, "sat":253, "effect":"none", "xy":[0.1684,0.0416], "ct":500};
	light[f_light + 1] 	= {"on":true, "bri":60, "hue":63494, "sat":253, "effect":"none", "xy":[0.6178,0.2911], "ct":500};
	light[f_light + 2] 	= {"on":true, "bri":100, "hue":48695, "sat":253, "effect":"none", "xy":[0.2115,0.0656], "ct":500};
	colorchange('Midnight');
	res.sendStatus(200);
});
